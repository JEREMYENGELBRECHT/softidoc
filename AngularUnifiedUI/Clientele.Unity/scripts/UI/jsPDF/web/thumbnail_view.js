...
var ThumbnailView = function thumbnailView(container, id, defaultViewport, selectThumbnails) {
    ...
    if (selectThumbnails) {
        ...
        var selectCheckBox = function (event,cb) {
            try {
                parent.SendIFrameData("ThumbnailSelectedFromPdfViewer", { Id: id-1, Checked: cb.checked });
                event.stopPropagation();
            } catch (e) {
                alert("Error on selectCheckbox ");
            }
        }
