...
angular.module('wysiwyg.module', ['colorpicker.module'])
    ...
    .factory('wysiwgGui', function () {
        ...
        var getMenuTextArea = function () {
            return '<div id="{{textareaId}}" style="resize:none;height:{{textareaHeight || \'80px\'}}; overflow:auto" contentEditable="true" class="{{textareaClass}} wysiwyg-textarea" rows="{{textareaRows}}" name="{{textareaName}}" required="{{textareaRequired}}" placeholder="{{textareaPlaceholder}}" ng-model="value"></div>';
        }
        ...
        var getMenuItem = function (item) {
            ...
            switch (item) {
                case 'bold':
                    return '<button title="Bold" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="format(\'bold\')" ng-class="{ active: isBold}"><i class="glyphicon glyphicon-bold"></i></button>';
                    break;
                case 'italic':
                    return '<button title="Italic" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="format(\'italic\')" ng-class="{ active: isItalic}"><i class="glyphicon glyphicon-italic"></i></button>';
                    break;
                case 'underline':
                    return '<button title="Underline" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="format(\'underline\')" ng-class="{ active: isUnderlined}"><i class="glyphicon glyphicon-text-underline"></i></button>';
                    break;
                case 'strikethrough':
                    return '<button title="Strikethrough" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="format(\'strikethrough\')" ng-class="{ active: isStrikethrough}"><i class="glyphicon glyphicon-text-strike"></i></button>';
                    break;
                case 'subscript':
                    return '<button title="Subscript" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="format(\'subscript\')" ng-class="{ active: isSubscript}"><i class="glyphicon glyphicon-text-subscript"></i></button>';
                    break;
                case 'superscript':
                    return '<button title="Superscript" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="format(\'superscript\')" ng-class="{ active: isSuperscript}"><i class="glyphicon glyphicon-text-superscript"></i></button>';
                    break;
                case 'font':
                ...
                case 'hilite-color':
                    ...
                    break;
                case 'remove-format':
                    return '<button title="Remove Formatting" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="format(\'removeFormat\')" ><i class="glyphicon glyphicon-remove"></i></button>';
                    break;
                case 'ordered-list':
                    return '<button title="Ordered List" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="format(\'insertorderedlist\')" ng-class="{ active: isOrderedList}"><i class="glyphicon glyphicon-list"></i></button>';
                    break;
                case 'unordered-list':
                    return '<button title="Unordered List" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="format(\'insertunorderedlist\')" ng-class="{ active: isUnorderedList}"><i class="glyphicon glyphicon-list"></i></button>';
                    break;
                case 'outdent':
                    return '<button title="Outdent" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="format(\'outdent\')"><i class="glyphicon glyphicon-indent-right"></i></button>';
                    break;
                case 'indent':
                    return '<button title="Indent" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="format(\'indent\')"><i class="glyphicon glyphicon-indent-left"></i></button>';
                    break;
                case 'left-justify':
                    return '<button title="Left Justify" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="format(\'justifyleft\')" ng-class="{ active: isLeftJustified}"><i class="glyphicon glyphicon-align-left"></i></button>';
                    break;
                case 'center-justify':
                    return '<button title="Center Justify" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="format(\'justifycenter\')" ng-class="{ active: isCenterJustified}"><i class="glyphicon glyphicon-align-center"></i></button>';
                    break;
                case 'right-justify':
                    return '<button title="Right Justify" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="format(\'justifyright\')" ng-class="{ active: isRightJustified}"><i class="glyphicon glyphicon-align-right"></i></button>';
                    break;
                case 'code':
                    return '<button title="Code" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="format(\'formatblock\', \'pre\')"  ng-class="{ active: isPre}"><i class="glyphicon glyphicon-list-alt"></i></button>';
                    break;
                case 'quote':
                    return '<button title="Quote" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="format(\'formatblock\', \'blockquote\')"  ng-class="{ active: isBlockquote}"><i class="glyphicon glyphicon-copyright-mark"></i></button>';
                    break;
                case 'paragragh':
                    ...
                    break;
                case 'link':
                    return '<button ng-show="!isLink" tabindex="-1" title="Link" type="button" unselectable="on" class="btn btn-default" ng-click="createLink()"><i class="glyphicon glyphicon-link" ></i> </button>' +
                    ...
                    break;
                case 'image':
                    return '<button title="Image" tabindex="-1" type="button" unselectable="on" class="btn btn-default" ng-click="insertImage()"><i class="glyphicon glyphicon-picture"></i> </button>';
                    break;
                default:
